      ...
      if (counter >= count - 1) begin
        ...
        case (STATE)
          ...
          State_running: begin
            ...
            $display("running d_x:%d head_x:%d counter:%d count:%d speed_x:%d",d_x, head_x, counter, count, speed_x);
            $display("running d_y:%d head_y:%d counter:%d count:%d speed_y:%d\n",d_y, head_y, counter, count, speed_y);
          end
          ...
          State_continue: begin
            case (axis_x)
              1'b1: begin
                ...
                $display("continue d_x:%d head_x:%d counter:%d mids:%d speed_x:%d",d_x, head_x, counter, mids, speed_x);
                $display("continue d_y:%d head_y:%d counter:%d mids:%d speed_y:%d\n",d_y, head_y, counter, mids, speed_y);
              end
              ...
              1'b0: begin
                ...
                $display("continue d_x:%d head_x:%d counter:%d mids:%d speed_x:%d",d_x, head_x, counter, mids, speed_x);
                $display("continue d_y:%d head_y:%d counter:%d mids:%d speed_y\n",d_y, head_y, counter, mids, speed_y);
              end
            endcase
          end
        endcase
