...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir Z:/vivado/fpga_final_project/fpga_final_project.runs/clk_wiz_0_synth_1 -new_name clk_wiz_0 -ip [get_ips clk_wiz_0]]
...
if { [catch {
  file copy -force Z:/vivado/fpga_final_project/fpga_final_project.runs/clk_wiz_0_synth_1/clk_wiz_0.dcp z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force Z:/vivado/fpga_final_project/fpga_final_project.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.v z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force Z:/vivado/fpga_final_project/fpga_final_project.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.vhdl z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force Z:/vivado/fpga_final_project/fpga_final_project.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.v z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force Z:/vivado/fpga_final_project/fpga_final_project.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.vhdl z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir Z:/vivado/fpga_final_project/fpga_final_project.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.v Z:/vivado/fpga_final_project/fpga_final_project.ip_user_files/ip/clk_wiz_0
  }
}

if {[file isdir Z:/vivado/fpga_final_project/fpga_final_project.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force z:/vivado/fpga_final_project/fpga_final_project.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_stub.vhdl Z:/vivado/fpga_final_project/fpga_final_project.ip_user_files/ip/clk_wiz_0
  }
}
